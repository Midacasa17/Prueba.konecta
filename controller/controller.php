...
class Controller
{
	...
	{
		if (isset($_POST['nombreProductoRegistrar']) && isset($_POST['referenciaRegistrar'])
		 && isset($_POST['precioRegistrar']) && isset($_POST['pesoRegistrar'])
		  && isset($_POST['categoriaRegistrar']) && isset($_POST['stockRegistrar'])
		   && isset($_POST['fechaCreacionRegistrar'])) {
			
			if ($_POST['nombreProductoRegistrar'] <> "" 
			&& $_POST['referenciaRegistrar'] <> "" 
			&& $_POST['precioRegistrar'] <> "" 
			&& $_POST['pesoRegistrar'] <> "" 
			&& $_POST['categoriaRegistrar'] <> "" 
			&& $_POST['stockRegistrar'] <> "" 
			&& $_POST['fechaCreacionRegistrar'] <> "") {
